...
# do
#     echo "Running..." $i
#     singularity exec ${container1} jupytext --sync $i".R"
#     singularity exec ${container1} jupytext --sync $i".ipynb"
#     singularity exec ${container1} jupyter nbconvert --to notebook --inplace --execute --ExecutePreprocessor.timeout=0 $i".ipynb"
#     singularity exec ${container1} jupytext --sync $i".ipynb"
# done
