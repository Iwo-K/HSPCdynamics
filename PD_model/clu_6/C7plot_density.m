...
exportfig(gcf,'./figures/density_clu_6.eps','FontMode', 'fixed','Fontsize',13,'color', 'cmyk','width',30,'height',20,'Renderer','painters','Lockaxes',0);%


dlmwrite('./tables/total_number_clu_6.txt',total_number)
