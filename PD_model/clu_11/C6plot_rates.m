...
load('./PD_matrixes/results_clu_11.mat')
...
exportfig(gcf,'./figures/rates_clu_11.eps','FontMode', 'fixed','Fontsize',13,'color', 'cmyk','width',30,'height',10,'Renderer','painters','Lockaxes',0);%


mat_parameters = [par.grid;par.D;drift_no_corr]';
mat_parameters2 = [par.gridx; par.a]';

dlmwrite('./tables/parameters_clu_11_dpt_diff_drift.txt',mat_parameters)
dlmwrite('./tables/parameters_clu_11_dpt_growth.txt',mat_parameters2)
