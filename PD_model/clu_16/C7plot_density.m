...
u3 = u3/trapz(x,u3);
u3 = ksdensity(D.ind.hist{1,28},x,'support',[0,1],'function','pdf');
u3 = u3/trapz(x,u3);
...
exportfig(gcf,'./figures/density_clu_16.eps','FontMode', 'fixed','Fontsize',13,'color', 'cmyk','width',30,'height',20,'Renderer','painters','Lockaxes',0);%

dlmwrite('./tables/total_number_clu_16.txt',total_number)
