...
# %%
parameters1 = pd.read_csv('./tables/parameters_clu_10_dpt_diff_drift.txt',
...
# %%
parameters2 = pd.read_csv('./tables/parameters_clu_10_dpt_growth.txt',
                          index_col=None,header=None)
...
# %%
df.to_csv('./tables/table_all_parameters_clu_10.csv')

# %%
df

# %%
plt.scatter(df.dpt_pseudotime,df.drift)
