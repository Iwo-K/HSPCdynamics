...
R = readtable('./tables/input_pseudo_dyn_rolling_clu_7_dpt.csv');
RN = readtable('./tables/input_pseudo_dyn_rolling_clu_7_size.csv');
Rfull = readtable('./tables/input_pseudo_dyn_clu_7_mk_dpt.csv');
...
save('./PD_matrixes/data_input_pd_rolling_clu_7','D');
