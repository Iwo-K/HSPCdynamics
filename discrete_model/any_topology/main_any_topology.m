...
name_best = './output/best_any_topology.txt';
...
M_temp = xlsread('any_topology.xlsx');
...
options=optimset('Display','Iter','TolX',1e-8,'TolFun',1e-8,'MaxFunEvals', 10000,'MaxIter',6000);%% change for multistart guess
...
if exist(name_best, 'file')==2
    ...
    guess = rand(1,number_parameters)*0.01;
