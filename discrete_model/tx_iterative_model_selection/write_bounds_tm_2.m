...
for n=1:27
    ...
    fName=['./pl_tm_2/r_',num2str(n),'tot.txt'];
    ...
    if exist(fName,'file')==2
        ...
        dlmwrite('./pl_tm_2/all_profiles.txt',data,'-append');
...
delete './pl_tm_2/bounds.txt'

data = dlmread('./pl_tm_2/all_profiles.txt');
...
ratio = maxi/best_base(vec_para(lookAt)+44);
    ...
    dlmwrite('./pl_tm_2/bounds.txt',[vec_para(lookAt),best(lookAt),maxi,mini,chi_max,chi_min,change,ratio],'-append')
end
