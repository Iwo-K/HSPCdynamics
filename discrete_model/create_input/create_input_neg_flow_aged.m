function create_input_neg_flow_aged
%% read data
...
data = readtable([dir_data 'model_input_tomneg_aged.csv']);
...
dlmwrite([dir_output 'input_neg_num_tot_nodivide_aged.txt'],[unique_time,means',err_sd'])
